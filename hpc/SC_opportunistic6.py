...
Writefilename="Table4_UDD_Opportunistic_medium"+str(lb)+".xlsx"
...
worksheet.write(0, 3, "Gap")

# endregion

global time_limit   #Time limit to solve each instance in second
time_limit=18000
global accepted_gap      #minimum gap
accepted_gap=0
...
for cc in range(lb,ub):
    ...
    def setupproblem():
        ...
        #problem.parameters.timelimit.set(2000)
        ...
        timelim_cb.timelimit = time_limit
        timelim_cb.acceptablegap = accepted_gap
        ...
        worksheet.write(cc, 2, timeused)
        worksheet.write(cc, 3, gap)
